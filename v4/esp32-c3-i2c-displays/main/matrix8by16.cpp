...
esp_err_t Matrix8by16::reset() {
    ...
    return i2c_master_write_to_device(0, device_address, buffer, sizeof(buffer), (500 / portTICK_RATE_MS));
}
...
esp_err_t Matrix8by16::test() {
    ...
    esp_err_t ret = i2c_master_write_to_device(0, device_address, buffer, sizeof(buffer), (500 / portTICK_RATE_MS));
