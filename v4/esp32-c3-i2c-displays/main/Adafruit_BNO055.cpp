 ...
 *  W. Beebe changes for ESP-IDF integration.
 *
 ...
 *          i2c address
 */
Adafruit_BNO055::Adafruit_BNO055(uint8_t _address) {
  address = _address;
}
...
uint8_t Adafruit_BNO055::read8(adafruit_bno055_reg_t reg) {
  ...
  i2c_master_write_read_device(0,address,buffer,1,buffer,1,1000 / portTICK_RATE_MS);
  return buffer[0];
}
