...
//
static std::string _page_heading;
//
// This is common to all web pages rendered in a users web browser.
//
void build_page_heading(const std::string &SSID) {
    _page_heading =
"<!DOCTYPE html>"
"<html>"
"<head>"
...
void build_web_page_footer(std::string &footer) {
...
"ESP-IDF Version: " + esp_get_idf_version() + "</h2>"
"<h2> " + get_time_now() + "</h2>"
"</body></html>";
}
...
static std::string _home_button;

std::string &home_button(std::string action) {
    build_web_page_footer(_footer);
