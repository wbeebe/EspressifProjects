 ...
 *
 *  This is a library for the BNO055 orientation sensor written specifically
 *  to work with the Adafruit BNO055 Breakout board.
 *
 ...
 *  Please support Adafruit's open-source efforts by purchasing products
 *  from Adafruit!
 *
 *  K. Townsend (Adafruit Industries) initial author.
...
// Offsets registers
//
const uint8_t NUM_BNO055_OFFSET_REGISTERS (22);
...
/*!
 *  @brief  Class that stores state and provides functions for interacting
 *          with the BNO055 Sensor.
 */
class Adafruit_BNO055 : Device {
public:
    Adafruit_BNO055(uint8_t _address = BNO055_ADDRESS_A);
